document.addEventListener('DOMContentLoaded', () => {
    ...
    // Enhanced loading states for buttons (excluding appointment forms)
    const submitButtons = document.querySelectorAll('button[type="submit"]:not([data-no-js-handling])');
    submitButtons.forEach(button => {
        // Skip if this is an appointment form button
        const form = button.closest('form');
        if (form && form.action && form.action.includes('schedule_appointment')) {
            return; // Skip appointment forms
        }
